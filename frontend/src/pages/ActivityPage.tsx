...
export default function ActivityPage({ isDarkTheme = false }: ActivityPageProps) {
  // Theme-based colors
  ...
  return (
    <div className={`h-full overflow-y-auto ${pageBg} ${pageText}`}>
      <div className="max-w-7xl mx-auto py-6 px-6 pr-2 pb-20">
        <AdminPageHeader isDarkTheme={isDarkTheme} title="Активность" />
        ...
        <div className={`${cardBg} rounded-xl border ${cardBorder} p-12`}>
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className={`${descriptionColor} max-w-md mb-6`}>
              Раздел "Активность" находится в активной разработке.
              Здесь будет отображаться статистика активности пользователей и репозиториев.
            </p>
